...
def create_simulation():
    ...
    Note: Parameters like max_rounds are intelligently generated by the LLM and do not require manual configuration.
...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    """
    Check whether simulation preparation is already complete
    ...
    try:
        ...
        # - completed: Finished running, preparation was completed earlier
...
def prepare_simulation():
    ...
    try:
        ...
        try:
            ...
            reader = ZepEntityReader()
            # Quick entity read (no edge info needed, only counting)
...
def get_simulation(simulation_id: str):
    ...
    try:
        ...
        # If simulation is prepared, append run instructions
...
def _get_report_id_for_simulation(simulation_id: str) -> str:
    ...
    If multiple exist, return the latest (sorted by created_at).
    ...
    try:
        ...
        logger.warning(f"Finding report for simulation {simulation_id}  failed: {e}")
        return None
...
def get_simulation_history():
    ...
    Used for home page historical project display, returns simulation list with rich info like project name, description
            ...
            "data": [
                {
                    ...
                    "simulation_requirement": "If Wuhan University released...",
                    "status": "completed",
                    "entities_count": 68,
                    "profiles_count": 68,
    ...
    try:
        ...
        for sim in simulations:
            ...
            if run_state:
                ...
                # Use user-set total_rounds, fall back to recommended rounds if not available
...
def get_simulation_config(simulation_id: str):
    ...
    try:
        ...
        if not config:
            return jsonify({
                "success": False,
                "error": f"Simulation config does not exist, please call /prepare endpoint first"
            }), 404
...
def start_simulation():
    ...
    About force parameter:
        ...
        - Suitable for scenarios that need to re-run the simulation
...
def interview_agent():
    ...
    try:
        ...
        if not SimulationRunner.check_env_alive(simulation_id):
            return jsonify({
                "success": False,
                "error": "Simulation environment not running or closed. Please ensure the simulation has completed and entered command-waiting mode."
            }), 400
...
def get_env_status():
    ...
    try:
        ...
        if env_alive:
            ...
            message = "Environment not running or has been closed"
