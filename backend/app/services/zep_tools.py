...
class InsightForgeResult:
    ...
    # Retrieval results from various dimensions
    ...
    def to_text(self) -> str:
        ...
        if self.semantic_facts:
            text_parts.append(f"\n### [Key Facts] (Please cite these originals in the report)")
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                if skip:
                    continue
                # Truncate overly long content (by period, not hard cut)
...
class ZepToolsService:
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges in the graph (with pagination, including temporal info)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Fetches all edges in the graph, then filters those related to the specified node
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function that auto-decomposes questions and performs multi-dimensional retrieval:
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Get a panoramic view, including all relevant content and historical/expired information:
        ...
        This tool is suitable for scenarios requiring understanding the full picture and tracking evolution.
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "6. Provide substantive content, answer at least 2-3 sentences per question\n\n"
        )
        optimized_prompt = f"{INTERVIEW_PROMPT_PREFIX}{combined_prompt}"

        # Step 4: Call real interview API (no platform specified, default dual-platform)
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                clean_text = re.sub(r'问题\d+[：:]\s*', '', clean_text)  # Remove "Question N:" markers (Chinese)
                ...
                meaningful = [
                    ...
                    and not s.strip().startswith(('{', '问题'))  # Filter out lines starting with "Question" (Chinese)
                ]
            ...
            result.summary = f"Interview failed: {str(e)}. The simulation environment may have been closed. Please ensure the OASIS environment is running."
            return result
        except Exception as e:
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable interview candidates from a list of simulated agents based on the interview requirements.
...
Please select up to {max_agents} agents most suitable for the interview and explain the reasoning."""
