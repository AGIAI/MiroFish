...
class OasisProfileGenerator:
    ...
    # Group/institution type entities (need to generate representative account personas)
    GROUP_ENTITY_TYPES = [
    ...
    def __init__(
        ...
        # Zep client for retrieving richer context
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use Zep graph hybrid search to obtain rich information about the entity

        Zep doesn't have a built-in hybrid search interface; needs to search edges and nodes
        separately then merge results. Uses parallel requests for efficiency.
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Check if entity is a group/institution type"""
    ...
    def _fix_truncated_json(self, content: str) -> str:
        ...
        # Simple check: if after the last quote there's no comma or closing bracket, string may be truncated
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        # 1. First try fixing truncated content
        content = self._fix_truncated_json(content)
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profiling expert. Generate detailed, realistic personas for public opinion simulation, maximizing restoration of existing real-world situations. You must return valid JSON format, and all string values must not contain unescaped newline characters. Use Chinese."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, maximizing restoration of existing real-world situations.
...
2. persona: Detailed persona description (2000 characters of plain text), must include:
   ...
   - Personal memory (important part of persona, must describe this individual's connection to events, and their existing actions and reactions in events)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account setting for this institution/group entity, maximizing restoration of existing real-world situations.
...
2. persona: Detailed account setting description (2000 characters of plain text), must include:
   - Institution basic info (official name, institution nature, founding background, main functions)
   ...
   - Institution memory (important part of institution persona, must describe this institution's connection to events, and its existing actions and reactions in events)
...
8. interested_topics: Array of focused areas
