...
Runs simulations in the background and records each Agent's actions, supporting real-time status monitoring
"""
...
class SimulationRunner:
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If only one platform was run, only check that platform
                                    # If both platforms were run, both need to complete
    ...
    def _read_actions_from_file(
        ...
        Args:
            ...
            default_platform: Default platform (used when action records don't have a platform field)
    ...
    def cleanup_all_simulations(cls):
        ...
        # Check if there's anything to clean up (avoid empty process printing useless logs)
    ...
    def close_simulation_env(
        ...
        Sends a close environment command to the simulation, making it gracefully exit the command waiting mode
