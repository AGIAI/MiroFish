...
class AgentActivity:
    ...
    def _describe_follow(self) -> str:
        """Follow user - includes target user's name"""
...
class ZepGraphMemoryUpdater:
    ...
    Groups activities by platform and sends them in batches to Zep after accumulating BATCH_SIZE activities.

    All meaningful actions are updated to Zep; action_args contains full context information:
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Per-platform activity buffers (each platform accumulates up to BATCH_SIZE before batch sending)
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        """
        Send activities to the Zep graph in batch (merged into a single text)
