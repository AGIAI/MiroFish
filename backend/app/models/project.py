...
Persists project state on the server side to avoid passing large data between frontend API calls.
"""
...
class Project:
    ...
    # Ontology information (populated after API step 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (populated after API step 2)
