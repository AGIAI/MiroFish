            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes their content and auto-generates an ontology structure (entity types + relation types) suitable for opinion simulation
                </div>
              </div>
