...
const handleNextStep = (params = {}) => {
  ...
  // If custom rounds are set, pass them via query params
  if (params.maxRounds) {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        // If graceful shutdown threw an exception, try force stop
        await forceStopSimulation()
      }
    } else {
    ...
    // Failure to check environment status does not block subsequent flow
