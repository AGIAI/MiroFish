    ...
    <div class=”main-content”>
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          ...
          <div class=”hero-desc”>
            <p>
              Even with just a piece of text, <span class=”highlight-bold”>MiroFish</span> can extract reality seeds and auto-generate a parallel world with up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view and find <span class=”highlight-code”>”local optima”</span> through complex group interactions in dynamic environments.
            </p>
            <p class=”slogan-text”>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & Profile generation & Environment config with Agent simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent with rich toolset deeply interacts with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
