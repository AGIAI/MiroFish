...
const parseInsightForge = (text) => {
  ...
  try {
    ...
    // Extract sub-queries - complete extraction, no limit
    ...
    // Extract key facts - complete extraction, no limit
    ...
    // Extract core entities - complete extraction, with summary and related facts count
    ...
    // Extract relation chains - complete extraction, no limit
...
const parsePanorama = (text) => {
  ...
  try {
    ...
    // Extract current active facts - complete extraction, no limit
    ...
    // Extract historical/expired facts - complete extraction, no limit
    ...
    // Extract involved entities - complete extraction, no limit
...
const parseQuickSearch = (text) => {
  ...
  try {
    ...
    // Extract related facts - complete extraction, no limit
    ...
    // Try extracting edge info (if available)
    ...
    // Try extracting node info (if available)
...
const InterviewDisplay = {
  ...
  setup(props) {
    ...
    // Try splitting answers by question numbering
    ...
    const hasMultiplePlatforms = (interview, qIdx) => {
      ...
      // Both platforms have real answers (not placeholders) and differ
...
const renderMarkdown = (content) => {
  ...
  // Clean up whitespace after list start tag
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Clean up whitespace before list end tag
...
const extractFinalContent = (response) => {
  ...
  // Try finding content after Final Answer: (multiple formats)
  ...
  // If content is long with markdown format, try removing thought process
